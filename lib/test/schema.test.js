...
describe('struct', () => {
    test('any field by string', () => {
        ...
        const generatedSchemas = schema_1.generateSchema([TestStruct]).get(TestStruct);
    ...
    test('struct fields', () => {
        ...
        const generatedSchemas = schema_1.generateSchema([TestStruct]);
...
describe('enum', () => {
    test('enum base', () => {
        ...
        const generatedSchemas = schema_1.generateSchema([TestEnum]);
...
describe('option', () => {
    test('field option', () => {
        ...
        const schema = schema_1.generateSchema([TestStruct]).get(TestStruct);
...
describe('order', () => {
    ...
    test('explicit non zero offset', () => {
        ...
        const thrower = () => {
            schema_1.generateSchema([TestStruct], true);
        };
