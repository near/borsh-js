...
function serializeField(schema, fieldName, value, fieldType, fieldMapper, writer) {
    ...
    try {
        ...
        if (typeof fieldType === 'string') {
            ...
            if (typeof fieldType[0] === 'number') {
                ...
                writer.writeArray(value, (item) => { serializeField(schema, fieldName, item, fieldType[0], undefined, writer); }, len);
            }
        }
...
function serializeStruct(schema, obj, writer) {
    ...
    if (structSchema.kind === 'struct') {
        structSchema.fields.map(([fieldName, fieldType, fieldMapper]) => {
...
function deserializeField(schema, fieldName, fieldType, fieldMapper, reader) {
    let result;
    try {
        if (typeof fieldType === 'string') {
